<!-- mobile nav -->
<header class="fixed flex z-50 bg-white w-full min-w-[320px] min-h-10 font-satoshimed" id="nav">
    ...
    <ul id="profDD" class="hidden bg-gradient-to-b from-white to-grey1 fixed z-50 block w-full h-full font-satoshimed top-10">
        ...
        <div class="relative block top-1/3 transform -translate-y-1/2 pt-24">
            ...
            <?php else: ?>
                ...
                <a href="/register"><h1 class="relative font-clashbold text-center left-1/2 transform -translate-x-1/2 text-black1 mt-6 tracking-tight bg-orangeaccent text-black1 w-3/4 p-2 py-4 rounded-xl border border-orangeaccent rounded-sm text-sm md:text-lg md:w-1/2">Sign up</h1></a>
            <?php endif; ?>
        </div> 
