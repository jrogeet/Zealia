...
<body class="bg-white1 flex flex-col justify-between">
    <?php view('partials/nav.view.php'); ?>
            ...
            <div class="h-[20.5625rem] flex justify-center items-center">
                <div class=" h-full w-[63.9375rem] flex justify-center items-center bg-cropped-breakdance bg-cover bg-no-repeat">
                    <div class="relative flex justify-center items-center">
                        ...
                        <span class="absolute font-synereg bg-orange1 bottom-4 -right-9 text-base px-2.5">generate teams by passion</span>
                    </div>
                </div>
            </div>
        ...
        <div class="flex justify-center items-center my-8 min-h-[112.5rem]">
            <div class="flex flex-col justify-evenly bg-howtouse bg-no-repeat bg-cover min-h-[106.25rem] w-[72rem] border-2 border-black1 rounded-2xl">
