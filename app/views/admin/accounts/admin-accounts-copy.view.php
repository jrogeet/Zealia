    ...
    <div class="z-40 relative block w-full h-fit py-12 px-6 min-w-[75rem] mb-16">
        <div class="relative flex mb-12">
            ...
            <div class="flex w-64 mx-auto text-lg font-satoshimed">
                <button onclick="show('allList','table-row-group'); hide('studentsList'); hide('profsList');" class="mx-auto text-center border border-black rounded-lg p-auto w-28 bg-blue2 hover:bg-blue3 hover:text-white">All</button>
                <button onclick="show('studentsList','table-row-group'); hide('allList'); hide('profsList');" class="mx-auto text-center border border-black rounded-lg p-auto w-28 bg-blue2 hover:bg-blue3 hover:text-white">Students</button>
                <button onclick="show('instructorsList','table-row-group'); hide('allList'); hide('studentsList');" class="mx-auto text-center border border-black rounded-lg p-auto w-28 bg-blue2 hover:bg-blue3 hover:text-white">Instructors</button>
            </div>
            <form method="POST" action="/admin-accounts" class="flex mx-auto w-fit">
                <input name="search_input" type="text" placeholder="Search..." class="pl-4 mx-auto border border-black rounded-lg bg-white" required>
            ...
            <table class="w-full leading-normal table-fixed rounded-xl">
                <thead class="min-w-[74.9rem] ">
                    <tr>
                        ...
                        <th class="px-0 py-3 text-xs font-semibold tracking-wider text-left text-center uppercase border-l border-r border-black bg-blue3 text-white">School ID</th>
                        <th class="px-0 py-3 text-xs font-semibold tracking-wider text-left text-center uppercase border-l border-r border-black bg-blue3 text-white">Surname</th>
                        ...
                        <th class="px-0 py-3 text-xs font-semibold tracking-wider text-left text-center uppercase border-l border-r border-black bg-blue3 text-white">Results</th>
                        <th class="px-0 py-3 text-xs font-semibold tracking-wider text-left text-center uppercase border-l border-r border-black bg-blue3 text-white">Registration Time</th>
                        <th class="px-0 py-3 text-xs font-semibold tracking-wider text-left text-center uppercase border-l border-r border-black bg-blue3 text-white">Activation</th>
                    </tr>
                </thead> -->
            ...
            <form method="POST" action="/admin-accounts" class="flex w-[60%] h-[90%] border border-black  rounded-2xl mx-auto p-6 pl-8">
                ...
                <div class="block w-[70%] h-full mx-auto">
                    ...
                    <select name="account_type" class="relative w-1/3 h-10 pl-4 mb-2 text-sm border border-black rounded-lg bg-blue2" name="category" id="reason" placeholder="Select Category" required>
                        ...
                        <option class="bg-beige" value="account">Admin</option>
                        <option class="bg-beige" value="rooms">instructor</option>
                        <option class="bg-beige" value="groups">Student</option>
                    </select>
                    
                    <h1 class="text-grey2 mt-[5%] mt-4">Name</h1>
                    <div class="flex">
                        <input name="f_name" type="text" class="w-1/3 h-10 pl-2 ml-0 border rounded-lg border-grey2 bg-white" placeholder="First Name" required></input>
                        <input name="l_name" type="text" class="w-1/3 h-10 pl-2 ml-4 border rounded-lg border-grey2 bg-white" placeholder="Last Name" required></input>
                    </div>

                    <h1 class="text-grey2 mt-[5%] mt-4">School number</h1>
                    <input name="school_id" type="number" class="w-1/3 h-10 pl-2 ml-0 border rounded-lg border-grey2 bg-white" placeholder="ID number" required></input>

                    <h1 class="text-grey2 mt-[5%] mt-4">Email</h1>
                    <input name="email" type="email" class="w-1/3 h-10 pl-2 ml-0 border rounded-lg border-grey2 bg-white" placeholder="Email" required></input>
                    
                    <h1 class="text-grey2 mt-[5%] mt-4">Set Password</h1>
                    <div class="flex">
                        <input name="password" type="text" class="w-1/3 h-10 pl-2 ml-0 border rounded-lg border-grey2 bg-white" placeholder="Password" required></input>
                        <input name="c_password" type="text" class="w-1/3 h-10 pl-2 ml-4 border rounded-lg border-grey2 bg-white" placeholder="Confirm Password" required></input>
                    </div>
                </div>
