            ...
            <div class="relative block w-[60%]">
                <div class="flex border border-black h-[40rem] rounded-2xl ml-12 p-6 pl-8">
                    <div class="block w-full my-auto">
                        ...
                        <input type="text" class="ml-0 w-full h-12 border border-grey2 rounded-lg bg-white1 pl-4" placeholder="<?= $allRoomInfo['room_name'] ?>"></input>
                        
                        <h1 class="text-grey2 mt-12">Change Instructor</h1>
                        <input type="text" class="ml-0 w-2/3 h-12 border border-grey2 rounded-lg bg-white1 pl-4" placeholder="<?= $allRoomInfo['school_id'] ?>"></input>
                        <h1 class="text-grey2 text-xs ml-2">Enter new Instructor's ID</h1>

                        <h1 class="text-grey2 mt-12">Room Code</h1>
                        <input type="text" class="ml-0 w-1/3 h-12 border border-grey2 rounded-lg bg-white1 pl-4" placeholder="<?= $allRoomInfo['room_code'] ?>"></input>
                    </div>
                </div>
            </div>
