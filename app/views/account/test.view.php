    ...
    <div class="font-satoshimed bg-white relative top-[14.50rem] mt-16 left-1/2 transform translate-x-[-50%] border border-black rounded-2xl shadow-2xl w-6/12 h-fit p-0 overflow-hidden">
        ...
        <div class="p-8 group hover:bg-blue3">
            <label class="flex items-center">
                <input type="checkbox" id="R" class="relative w-5 h-5 border rounded appearance-none cursor-pointer peer min-w-5 border-grey2 bg-white2 checked:bg-orangeaccent">
                <span class="ml-2 text-gray-700 group-hover:text-white" id="R">I like to work on cars</span>
            </label>
        </div>
        <div class="p-8 group hover:bg-blue3">
            <label class="flex items-center">
                <input type="checkbox" id="I" class="relative w-5 h-5 border rounded appearance-none cursor-pointer peer min-w-5 border-grey2 bg-white2 checked:bg-orangeaccent">
                <span class="ml-2 text-gray-700 group-hover:text-white">I like to do puzzles</span>
            </label>
        </div>
        <div class="p-8 group hover:bg-blue3">
            <label class="flex items-center">
                <input type="checkbox" id="A" class="relative w-5 h-5 border rounded appearance-none cursor-pointer peer min-w-5 border-grey2 bg-white2 checked:bg-orangeaccent">
                <span class="ml-2 text-gray-700 group-hover:text-white">I am good at working independently</span>
            </label>
        </div>
        <div class="p-8 group hover:bg-blue3">
            <label class="flex items-center">
                <input type="checkbox" id="S" class="relative w-5 h-5 border rounded appearance-none cursor-pointer peer min-w-5 border-grey2 bg-white2 checked:bg-orangeaccent">
                <span class="ml-2 text-gray-700 group-hover:text-white">I like to work in teams</span>
            </label>
        </div>
        <div class="p-8 group hover:bg-blue3">
            <label class="flex items-center">
                <input type="checkbox" id="E" class="relative w-5 h-5 border rounded appearance-none cursor-pointer peer min-w-5 border-grey2 bg-white2 checked:bg-orangeaccent">
                <span class="ml-2 text-gray-700 group-hover:text-white">I am an ambitious person, I set goals for myself</span>
            </label>
        </div>
        <div class="p-8 group hover:bg-blue3">
            <label class="flex items-center">
                <input type="checkbox" id="C" class="relative w-5 h-5 border rounded appearance-none cursor-pointer peer min-w-5 border-grey2 bg-white2 checked:bg-orangeaccent">
