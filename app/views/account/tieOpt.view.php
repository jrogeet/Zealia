...
<body class="w-full overflow-y-scroll overflow-x-hidden static block">
    ...
    <div class="relative w-full h-[47rem] top-[5rem] pt-32 mb-44 block">
        ...
        <div class="font-satoshiblack text-left relative w-8/12 h-fit left-[53%] mb-0 transform translate-x-[-50%] flex">
            ...
            <h1 class="relative text-[6rem] font-ginto top-[-2.2rem] ml-4" id="tempResDisplay"></h1>
        </div>
    ...
    <div class="relative block w-full h-fit mb-12">
        <div class="text-center font-clashbold text-grey2 text-4xl tracking-wider">TIE BREAKER</div>
        ...
        <div class="font-satoshiblack mt-12 text-right relative h-fit left-[12%] inline-block">
            ...
            <h1 class="relative text-4xl font-ginto top-[-2.2rem] ml-14" id="opCountDisplay"></h1>
        </div>

        <div class="font-satoshimed bg-white1 relative block mb-20 left-1/2 transform translate-x-[-50%] border border-black rounded-2xl shadow-2xl w-6/12 h-fit p-0 overflow-hidden mt-20" id="opCont">
        </div>
