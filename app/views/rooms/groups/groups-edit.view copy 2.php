...
<body class="bg-white1 block">
    ...
    <button onclick="checkGroups();" class="relative left-1/2 transform -translate-x-1/2 border border-black w-36 bg-blue3 text-white1 font-satoshimed h-8 rounded-lg mb-16">Submit</button>
