                            ...
                            <div id="kickConfirmation<?= $student['school_id'] ?>" class="fixed left-0 justify-center hidden w-screen h-screen pt-56 bg-glassmorphism top-20">
                                <div class="flex flex-col h-40 border rounded-t-lg bg-white2 w-80 border-black1">
                                    ...
                                    <form action="/room" method="POST" class="flex flex-col items-center p-2 h-60">
                                        ...
                                        <button type="submit" name="delete" value="<?php echo implode(',', [$student['school_id'], $_GET['room_id']]); ?>"  class="w-16 border rounded bg-red1 text-white1 border-black1">Confirm</button>
                                    </form>
                                </div>
                            </div>
                        <?php endforeach; ?>
                        ...
                        <?php foreach($requests as $request): ?>
                            <div class="flex items-center justify-between w-full h-20 px-2 border bg-blue1 border-black1">
                                ...
                                <form method="POST" action="/room" class="flex w-16 h-6 justify-evenly">
                                    <button class="w-6 h-6 bg-cover cursor-pointer bg-check" type="submit"  name="accept" value="<?php echo implode(',', [$request['school_id'], $_GET['room_id']]); ?>"> </button>
                                    <button class="w-6 h-6 bg-cover cursor-pointer bg-cross" type="submit" name="decline" value="<?php echo implode(',', [$request['school_id'], $_GET['room_id']]); ?>"> </button>
                                </form>
                            </div>
                        <?php endforeach; ?>
                    </div>
