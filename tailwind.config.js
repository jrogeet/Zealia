...
module.exports = {
  ...
  theme: {
    extend: {
      backgroundImage: {
        "cropped-breakdance":
          "url('/assets/images/vectors/human/breakdance-whiteshade-cropped.png')",
        "threshold-cropped-solid":
          "url('/assets/images/threshold-cropped-solid.webp')",
        ...
        "cs-beige":
          "url('/assets/images/custom/dashboard-rooms/cs-beige.webp')",
        "it-beige":
          "url('/assets/images/custom/dashboard-rooms/it-beige.webp')",
      ...
      boxShadow: {
        inside:
          "rgb(255, 200, 180) 3px 3px 6px 0px inset, rgba(255, 255, 255, 0.6) -3px -3px 6px 1px inset",
        inside1:
