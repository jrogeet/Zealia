...
CREATE TABLE `accounts` (
  ...
  `account_type` enum('student','professor','admin') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'student',
...
CREATE TABLE `notifications` (
  ...
  `notif_type` enum('join_room','room_accept','room_decline','group_create','group_modify','account','prejoin') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='List of Students in per room\r\n';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ticket` (
  ...
  `school_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
